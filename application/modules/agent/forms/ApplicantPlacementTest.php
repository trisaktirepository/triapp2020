<?
class Agent_Form_ApplicantPlacementTest extends Zend_Form {
	...
	public function init(){
    	...
    	$placement_test_info = $applicantPlacementScheduleDB->getAvailableDateAgent($this->applid,$this->transactionid);
		...
		$this->addElement('select','aps_id', array(
			'label'=>'Location','required'=>true,'RegisterInArrayValidator' => false,'onChange'=>"getFees(this);"
		));	
