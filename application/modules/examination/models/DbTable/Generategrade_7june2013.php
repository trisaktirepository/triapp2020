...
class Examination_Model_DbTable_Generategrade extends Zend_Db_Table { //Model Class for Users Details
	...
	public function fnGetStudents($post = array()){	
		...
		//->join(array("sme" =>"tbl_student_marks_entry"),"sme.IdStudentRegSubjects = studregsubj.IdStudentRegSubjects AND sme.Course=studregsubj.IdSubject AND  sme.IdStudentRegistration=studregsubj.IdStudentRegistration  ",array('sme.IdStudentMarksEntry','sme.MarksEntryStatus','sme.Component'))
		//->join(array("sdme" =>"tbl_student_detail_marks_entry"),"sdme.IdStudentMarksEntry = sme.IdStudentMarksEntry ",array('sdme.TotalMarks'))
		;
