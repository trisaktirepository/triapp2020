...
class GeneralSetup_TakafulController extends Zend_Controller_Action {
	/**
	 * The default action - show the home page
	 */
	public function indexAction() {
		//title
    	$this->view->title="Takaful Operator Setup";
    	
    	//paginator
		$clientTypeDB = new App_Model_General_DbTable_TakafulOperator();
	...
	public function addTypeAction()
    {
		...
		if ($this->getRequest()->isPost()) {
			...
			$formData = $this->getRequest()->getPost();
				//process form 
				$faculty = new App_Model_General_DbTable_TakafulOperator();
	...
	public function editTypeAction(){
		//title
    	$this->view->title="Edit Takaful Operator";
    	...
    	if ($this->getRequest()->isPost()) {
    		...
    		$formData = $this->getRequest()->getPost();
				...
				$type = new App_Model_General_DbTable_TakafulOperator(); 
