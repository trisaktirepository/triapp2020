...
class GeneralSetup_Form_Venue extends Zend_Form
{
	protected $branchid, $officeid, $url;
	...
	public function init()
	{
		...
		$this->type->addMultiOption(null,"-- Select Venue Type --");
		foreach ($venue_type as $list){
			$this->type->addMultiOption($list['id'],$list['name']);
		}
		...
		$this->addElement('text','clearpass', array(
			'label'=>'Password',
			'required'=>'true'));
