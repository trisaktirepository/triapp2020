...
class Exam_Model_DbTable_Assessmenttype extends Zend_Db_Table_Abstract { //Model Class for Users Details
	...
	public function fngetAllassessmentType() {
		...
		->from(array('a' => 'tbl_examination_assessment_type'), array('a.IdDescription','a.Description','a.DescriptionDefaultlang'));
	...
	public function fnGetAssesmentTypeNamebyID($idcomp) {
		$lstrSelect = $this->lobjDbAdpt->select()
		->from(array('a' => 'tbl_examination_assessment_type'), array("a.Description"))
