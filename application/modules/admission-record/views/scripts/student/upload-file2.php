...
$("input").uniform();
        ...
        function monitorUpload() {
            ...
            var progress_action = "<?php echo $this->baseUrl('/admission-record/student/progress'); ?>";
        
            // where should we go after successful upload
            var success_action = "<?php echo $this->baseUrl('/admission-record/student/success'); ?>";
...
<script type="text/javascript">
    ...
    $("#uploadprogressbar").progressBar({
        boxImage: image_base_path + '/images/uploadbar/progressbar.gif',
        barImage: {
            0: image_base_path + '/images/uploadbar/progressbg_red.gif',
            30: image_base_path + '/images/uploadbar/progressbg_orange.gif',
            70: image_base_path + '/images/uploadbar/progressbg_green.gif'
        }
    }
);
</script>
