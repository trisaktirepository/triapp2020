...
class Finance_Model_DbTable_Student extends Zend_Db_Table_Abstract {
	/**
	 * The default table name 
	 */
	protected $_name = 'student';
	protected $_primary = "studentID";
	...
	public function getJoinData($table,$join,$on,$where=0,$order=0){
		$db = Zend_Db_Table::getDefaultAdapter();
