...
class Finance_FeecomponentController extends Zend_Controller_Action {
	/**
	 * The default action - show the home page
	 */
	public function indexAction() {
		//title
    	$this->view->title="Fee Component Setup";
    	
    	//paginator
		$clientTypeDB = new Finance_Model_DbTable_Feecomponent();
