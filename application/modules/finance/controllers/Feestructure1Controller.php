...
class Finance_Feestructure1Controller extends Zend_Controller_Action {
	/**
	...
	public function indexAction() {
		...
		$coursedata = $courseDB->getPaginateData();
		
		$paginator = new Zend_Paginator(new Zend_Paginator_Adapter_DbSelect($coursedata));
    ...
    {
    	//title
    	$this->view->title="Add Fee Component";
		...
		if ($this->getRequest()->isPost()) {
			...
			$formData = $this->getRequest()->getPost();
				//process form 
				$faculty = new Finance_Model_DbTable_Feecomponent();
	...
	public function editTypeAction(){
    	...
    	if ($this->getRequest()->isPost()) {
    		...
    		$formData = $this->getRequest()->getPost();
				...
				$type = new Finance_Model_DbTable_Feecomponent(); 
