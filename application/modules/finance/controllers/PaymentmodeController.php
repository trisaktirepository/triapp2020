...
class Finance_PaymentmodeController extends Zend_Controller_Action {
	/**
	 * The default action - show the home page
	 */
	public function indexAction() {
		//title
    	$this->view->title="Payment Mode Setup";
    	
    	//paginator
		$clientTypeDB = new Finance_Model_DbTable_Paymentmode();
