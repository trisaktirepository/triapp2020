 ...
 * @author Suliana
 */
class Onapp_Model_DbTable_Program extends Zend_Db_Table_Abstract {
	/**
	 * The default table name 
	 */
	protected $_name = "sc001_program";
	protected $_primary = "sc001_program_id";
	...
	public function getProgram($cond){
		$db = Zend_Db_Table::getDefaultAdapter();
