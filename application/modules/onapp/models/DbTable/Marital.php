...
class Onapp_Model_DbTable_Marital extends Zend_Db_Table_Abstract {
	/**
	 * The default table name 
	 */
	protected $_name = 'hg002_marital_status';
	protected $_primary = "hg002_marital_id";
	...
	public function getMarital($cond){
		$db = Zend_Db_Table::getDefaultAdapter();
