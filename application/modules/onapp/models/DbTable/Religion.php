...
class Onapp_Model_DbTable_Religion extends Zend_Db_Table_Abstract {
	/**
	 * The default table name 
	 */
	protected $_name = 'hg003_religion';
	protected $_primary = "hg003_religion_id";
	...
	public function getReligion($cond){
		$db = Zend_Db_Table::getDefaultAdapter();
