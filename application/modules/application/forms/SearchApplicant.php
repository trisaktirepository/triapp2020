...
class Application_Form_SearchApplicant extends Zend_Form
{
	...
	public function init()
	{
		...
		$this->selection_status->addMultiOption('APPLY',"Apply");
		$this->selection_status->addMultiOption('',"Submitted");
		$this->selection_status->addMultiOption(2,"Offer");
		$this->selection_status->addMultiOption(2,"rEJECT");		
		*/
