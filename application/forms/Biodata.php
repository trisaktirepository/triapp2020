...
class App_Form_Biodata extends Zend_Form {
	...
	public function init(){
		...
		$this->appl_religion->addMultiOption(null,$this->getView()->translate('Please Select'));
		...
		//parent salary
		$this->addElement('text','appl_parent_salary', array(
				'label'=>$this->getView()->translate('Parent Salary (Monthly)'),
				'placeholder'=>'1000000.00',
				'decorators'=>array(
						'ViewHelper',
						'Description',
						'Errors',
						array(array('data'=>'HtmlTag'), array('tag' => 'td', 'colspan'=>'3','style'=>'text-align:top;')),
						array('Label', array('tag' => 'td' )),
						array(array('row'=>'HtmlTag'),array('tag'=>'tr'))
				),
				'required'=>true,
		...
		$validator=new Zend_Validate_GreaterThan(1000000);
		$this->appl_parent_salary->addValidator($validator,true);

		$this->appl_parent_salary->addValidator('Regex',false, array('pattern' =>'/^\$?[0-9]+(,[0-9]{3})*(.[0-9]{2})?$/', 'messages'=>'Please enter valid currency amount'));
