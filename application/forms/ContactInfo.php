...
class App_Form_ContactInfo extends Zend_Form {
	...
	public function init(){
		...
		$this->addElement('text','appl_caddress_rt', array(
				'label'=>$this->getView()->translate('RT'),
				'required'=>true));
		
		$this->addElement('text','appl_caddress_rw', array(
				'label'=>$this->getView()->translate('RW'),
				'required'=>true));

		
		$this->addElement('text','appl_ckelurahan', array(
				'label'=>$this->getView()->translate('Kelurahan'),
				'required'=>true
		));
		
		$this->addElement('text','appl_ckecamatan', array(
				'label'=>$this->getView()->translate('Kecamatan'),
				'required'=>true
		));
