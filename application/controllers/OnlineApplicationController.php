...
class OnlineApplicationController extends Zend_Controller_Action {
	...
	public function indexAction(){
    	...
    	foreach ($placementtest as $key=>$value) {
    		$period=$dbPeriod->getActivePlacementTestData($value['aph_placement_code']);
...
/*		echo $this->encrypt_decrypt($data["stusername"],false);
    ...
    public function ajaxSaveMkAction(){
	...
	public function uploaddocumentAction(){
		...
		*/
		...
		else if ($transaction["at_appl_type"]=="5" || $transaction["at_appl_type"]=="8" || $transaction["at_appl_type"]=="9" || $transaction["at_appl_type"]=="10") $testCode='PORTOFOLIO';
...
//						
	...
	//transaction data
		...
		else if ($transaction["at_appl_type"]=="5" || $transaction["at_appl_type"]=="8" || $transaction["at_appl_type"]=="9") $testCode='PORTOFOLIO';
		else if ($transaction["at_appl_type"]=="6") $testCode='SCHOLARSHIP';
		else if ($transaction["at_appl_type"]=="7") $testCode='UTBK';
		else {
			$ptest=$dbAppTest->getPtest($transaction_id);
...
/*			print_r($fieldValues);
	...
	public function createUsmCardAction(){
		...
		*/
		...
		//echo $auth->getIdentity()->role;
				...
				$this->_redirect('/online-application/viewkartu');
    ...
    public function saveCreditTransfer($formData) {
    ...
    public function creditHourApplyAction()
    {
        ...
        if($this->getRequest()->isPost())
        {
            ...
            //delete ptest
            $applicantProgramDb->deleteTransactionData($transaction_id);
