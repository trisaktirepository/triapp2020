...
class App_Model_Record_DbTable_StudentRegistration extends Zend_Db_Table_Abstract {
	...
	public function getStudentInfo($id=0) {
		...
		$select = $db->select()
				...
				->join(array('p'=>'tbl_program'),'p.IdProgram=sr.IdProgram',array('ArabicName','ProgramName','ProgramCode','IdProgram','AdvisorDefaultApprove','Departement','Dept_Bahasa','strata','StrataName','OptimalDuration','Gradepoint_rmd','paket','print_majoring','MeetAdvisor','kkni'=>'KKNI_level'))
