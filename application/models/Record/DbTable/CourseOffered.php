		...
		if($semesterID!=0){
			...
			if($departmentID==0){
				$select = $db->select()
						...
						->joinLeft(array('c'=>'r010_course'), 'c.id = co.course_id',array('course_id'=>'id','course_name'=>'name','course_code'=>'code','course_credit_hour'=>'credit_hour'))
				...
				$select = $db->select()
						...
						->join(array('c'=>'r010_course'), 'c.id = co.course_id',array('course_id'=>'id','course_name'=>'name','course_code'=>'code','course_credit_hour'=>'credit_hour'))
						->joinLeft(array('d'=>'g008_department'), 'd.id = c.department_id',array('department_name'=>'name','department_code'=>'code'));	
			}
