...
class App_Model_Registration_DbTable_CourseGroupMinor extends Zend_Db_Table_Abstract {
	...
	public function getGroupList($idgrup){
		...
		$select = $db ->select()
					  ...
					  ->join(array('cgt'=>'tbl_course_tagging_group'),'cgt.IdCourseTaggingGroup=cg.group_id',array())
					  ->join(array('s'=>'tbl_semestermaster'),'s.IdSemesterMaster=cgt.IdSemester',array('semester_name'=>'SemesterMainName'))
	...
	public function getCourseTaggingGroupListForMarkEntry($idSemester,$idprogram=null,$idsubject=null,$branch=null){
	...
	public function getCountStudentByGroup($idGroup){
		...
		$select = $db ->select()
		->from(array('a'=>'course_group_student_minor'),array('nOfStudent'=>'count(*)'))
	...
	public function getCapacity($idGroup){
