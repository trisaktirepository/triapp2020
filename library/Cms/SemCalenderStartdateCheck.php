<?php
class Cms_SemCalenderStartdateCheck extends Zend_Validate_Abstract {
    ...
    protected $_messageTemplates = array(
        self::NOT_MATCH => "Start date should be lies between semester start date (%start%) and semester end date (%end%)",
    );
