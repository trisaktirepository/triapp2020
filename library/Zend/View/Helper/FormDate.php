...

{
...

    {
        ...
        if( isset($attribs['locale']) ){
        	setlocale(LC_ALL, $attribs['locale']);	
        }else{
        ...
        for ($i = 1; $i < 13; $i ++)
        {
            ...
            $monthMultiOptions[$index] = strftime('%B', mktime(null, null, null, $i, 01));
            //echo $date->get(Zend_Date::MONTH_NAME,'id_ID');
